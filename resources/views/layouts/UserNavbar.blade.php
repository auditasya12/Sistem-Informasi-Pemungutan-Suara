    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse justify-content-between" id="navbarNav">
            ...
            <div class="navbar-nav p-3">
                ...
                @else
                <!-- Menggunakan Blade Template untuk Menetapkan Kelas Aktif -->
                <a class="btn btn-success {{ Request::routeIs('login') ? 'active' : '' }}" style="margin-right:3px" href="{{ route('login') }}">
                    <i class="bi bi-box-arrow-in-right"></i> Masuk
                </a>
                <a class="btn btn-warning {{ Request::routeIs('register') ? 'active' : '' }}" href="{{ route('register') }}">
                    <i class="bi bi-box-arrow-in-down"></i> Daftar
                </a>
