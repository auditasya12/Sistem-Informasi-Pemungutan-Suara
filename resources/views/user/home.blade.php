<x-user-layout>
    <div class="pt-2 pb-0 pb-lg-3 rounded align-middle" id="homePage">
        <div class="row h-100 g-0 mb-5 justify-content-center">
            <div class="col-lg-12 my-auto">
                <div class="text-center mx-auto">
                    <img src="/assets/img/vote.png" class="img-fluid img-responsive rounded-3 shadow-sm" style="width:20%;height:auto" alt="evote">
                </div>
            </div>
